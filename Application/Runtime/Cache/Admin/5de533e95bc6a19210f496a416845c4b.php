        ...
        <table cellspacing=0 cellpadding=0 width="100%" 
            ...
            <tr height=56>
                ...
                <td style="font-weight: bold; color: #fff; padding-top: 20px" 
                    align=middle>当前用户：<?php echo session('username');?> &nbsp;&nbsp; <a style="color: #fff"href="" target=main>修改口令</a> &nbsp;&nbsp; 
                    <a style="color: #fff" onclick="if (confirm('确定要退出吗？')) return true; else return false;" href="<?php echo U('Login/logout');?>" target=_top>退出系统</a>
                </td>
