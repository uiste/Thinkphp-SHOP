...
<div class="admin-biaogelist">
    ...
    <div class="fbneirong">
      <form class="am-form" action="/index.php/Admin/Auth/add" method="post">
        <div class="am-form-group am-cf">
          <div class="zuo">权限名称：</div>
          <div class="you">
            <input type="text" name="auth_name" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入权限名称">
          </div>
        </div>
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            <select name="auth_pid">
              ...
              <?php if(is_array($authData)): $i = 0; $__LIST__ = $authData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["auth_id"]); ?>"><?php echo (str_repeat('&emsp;',$vo["level"]*2)); echo ($vo["auth_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
          </div>
        </div>
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            <input type="text" name="auth_c" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入控制器名">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">权限方法</div>
          <div class="you">
            <input type="text" name="auth_a" class="am-input-sm" id="doc-ipt-email-1" placeholder="请再次输入方法名">
          </div>
        </div>
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            ...
            <label class="am-radio-inline"><input type="radio" value="0" name="is_show"> 否</label>
          </div>
        </div>
        <div class="am-form-group am-cf">
