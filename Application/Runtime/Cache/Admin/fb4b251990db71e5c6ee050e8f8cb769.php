...
<div class="admin-biaogelist">
  <form class="am-form" action="/index.php/Admin/Goods/edt/id/22" method="post" enctype="multipart/form-data">
        ...
        <div class="am-tabs-bd" style="touch-action: pan-y; -webkit-user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
            <div class="am-tab-panel am-fade am-active am-in" id="tab1">
                ...
                <div class="am-g am-margin-top">
                    ...
                    <div class="you" style="width: 40%;float:left;margin-left:20px;">
                      <input type="text" name="goods_sn" value="<?php echo ($goodsInfo["goods_sn"]); ?>" id="doc-vld-name-1" placeholder="输入商品货号，如果您不输入系统会自动生成一个唯一货号" class="am-form-field" >
                    </div>
                </div>
                <div class="am-g am-margin-top">
                    <div class="am-u-sm-4 am-u-md-2 am-text-right">
                    ...
                    <div class="you" style="width: 40%;float:left;margin-left:20px;">
                      <select name="cate_id">
                          ...
                          <?php if(is_array($cateData)): $i = 0; $__LIST__ = $cateData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cate_id"]); ?>" <?php echo $vo['cate_id'] == $goodsInfo['cate_id']?'selected':'' ?> ><?php echo str_repeat('&nbsp;',$vo['level']*5); echo ($vo["cate_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
                <div class="am-g am-margin-top">
                    ...
                    <div class="you" style="width: 40%;float:left;margin-left:20px;">
                      <input type="text" name="goods_number" value="<?php echo ($goodsInfo["goods_number"]); ?>" id="doc-vld-name-1" class="am-form-field" required="">
                    </div>
                </div>
                <div class="am-g am-margin-top">
                    <div class="am-u-sm-4 am-u-md-2 am-text-right">
            ...
            <div class="am-tab-panel am-fade" id="tab2">
                    ...
                    <div class="you" style="width: 100%;float:left;margin:0 20px;">
                      <script id="editor" name="goods_descp" type="text/plain" style="width:100%;height:500px;"><?php echo ($goodsInfo["goods_descp"]); ?></script>
                    </div>
                </div>
            </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="you" style="max-width: 300px;">
                                <select name="type_id" id="type_select">
                                  <option value="0">请选择商品类型</option>
                                  <?php if(is_array($typeData)): $i = 0; $__LIST__ = $typeData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["type_id"]); ?>" <?php echo $vo['type_id']==$goodsInfo['type_id']?'selected':''; ?>><?php echo ($vo["type_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
